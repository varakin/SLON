...
class OARegistrationNoCardLoginBusy(unittest.TestCase):
    def setUp(self):
    ...
    def test_o_a_registration_no_card_login_busy(self):
        driver = self.driver
        ...
        try: self.assertEqual(u"Указанный логин уже зарегистрирован", driver.find_element_by_css_selector("h3").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_css_selector("div.error > div").click()
        try: self.assertEqual(u"Регистрация", driver.find_element_by_css_selector("h4").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual(u"я знаю номер SIM-карты моего устройства", driver.find_element_by_css_selector("#haveGsm > span").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
