...
class OARegistrationNoCardTrueTrueTrue(unittest.TestCase):
    def setUp(self):
    ...
    def test_o_a_registration_no_card_true_true_true(self):
        driver = self.driver
        ...
        driver.find_element_by_name("email").send_keys("varakin.123@mail.ru")
        ...
        try: self.assertEqual(u"Письмо для подтверждения регистрации выслано Вам на указанную почту.", driver.find_element_by_css_selector("h3").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
