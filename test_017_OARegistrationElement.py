...
#        try: self.assertRegexpMatches(driver.find_element_by_css_selector("h5").text, r"У Вас есть карта активации")
        try: self.assertEqual(u"У Вас есть карта активации?", driver.find_element_by_css_selector("h5").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertEqual(u"Нет карты", driver.find_element_by_id("card-no").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual(u"Есть карта", driver.find_element_by_id("card-yes").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
