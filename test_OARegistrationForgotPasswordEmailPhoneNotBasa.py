...
class OARegistrationForgotPasswordEmailPhoneNotBasa(unittest.TestCase):
    def setUp(self):
    ...
    def test_o_a_registration_forgot_password_email_phone_not_basa(self):
        driver = self.driver
        driver.get(self.base_url + "/")
        driver.find_element_by_xpath("//div[@id='register']/span[2]").click()
        driver.find_element_by_id("card-yes").click()
        ...
        driver.find_element_by_name("contact").send_keys("111111@111111.ru")
        driver.find_element_by_css_selector("button.form-button.enter").click()
        try: self.assertEqual(u"Контакт не найден или не подтвержден.", driver.find_element_by_css_selector("h3").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_name("contact").clear()
        driver.find_element_by_name("contact").send_keys("79211111111")
        driver.find_element_by_css_selector("button.form-button.enter").click()
        try: self.assertEqual(u"Контакт не найден или не подтвержден.", driver.find_element_by_css_selector("h3").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_css_selector("div.error > div").click()
