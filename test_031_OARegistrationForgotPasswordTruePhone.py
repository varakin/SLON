...
class OARegistrationForgotPasswordTruePhone(unittest.TestCase):
    def setUp(self):
    ...
    def test_o_a_registration_forgot_password_true_phone(self):
        driver = self.driver
        ...
        driver.find_element_by_name("contact").send_keys("79213111719")
